...
import { Home, BookMarked, Bookmark, Settings } from "lucide-react";
      ...
      <div>
        ...
        <nav className="flex flex-col gap-2 mt-4">
          ...
          <SidebarItem
            ...
            active={pathname.startsWith("/dashboard/books-create")}
            expanded={isExpanded}
          ...
          <SidebarItem
            ...
            active={pathname.startsWith("/dashboard/peminjaman")}
            expanded={isExpanded}
            onClick={() => router.push("/dashboard/peminjaman")}
          />
          ...
          <SidebarItem
            icon={<Bookmark size={20} />}
            label="Buku"
            href="/dashboard/books-lists"
            active={pathname.startsWith("/dashboard/books-lists")}
            expanded={isExpanded}
            onClick={() => router.push("/dashboard/books-lists")}
          />
